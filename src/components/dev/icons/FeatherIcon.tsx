...
type FeatherType = typeof FeathersConst[keyof typeof FeathersConst];


const feathers = Object.values(FeathersConst) as FeatherType[];
...
const FeatherIcon: React.FC = () => {
  return (
    ...
    >
      <h1 style={{ fontSize: '30px' }}>Feather 아이콘 모음</h1>
      <section
        style={{
          marginTop: '50px',
          padding: '10px',
        ...
        {feathers.map((feather) => (
          ...
          >
            ...
            <article style={{ marginTop: '8px' }}>
              <span style={{ fontSize: '14px', color: '#667085' }}>{feather}</span>
            </article>
          </div>
        ))}
      </section>
